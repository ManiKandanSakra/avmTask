            ...
            <Card className='card-first'>  
                <Card.Body className='card-body'>  
                    ...
                    <div className='d-flex justify-content-between tempContent'> 
                        ...
                        <span><h5><img src={fire} className='fire-icon' alt="fire"/>26 <span className='content-celcious'>°C</span></h5></span> <hr></hr> 
                        <h5><img src={snowflake} className='fire-icon' alt="snowflake"/>18 <span className='content-celcious'>°C</span></h5></div>
                    </div>
                </Card.Body>  
            </Card> 
        )
